    ...
    for epoch in range(first_epoch, args.num_train_epochs):
        ...
        for step, batch in enumerate(train_dataloader):
            with accelerator.accumulate(unet):
                ...
                cond_pixel_values = batch["cond_values"].to(device=latents.device, dtype=weight_dtype)
                encoder_hidden_states = image_encoder.get_image_features(pixel_values=cond_pixel_values)
